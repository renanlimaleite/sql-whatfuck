/*
OR -> PARA SER VERDADEIRA, BASTA APENAS UMA VERDADEIRA
AND -> PARA SER VERDADEIRA, PRECISA TODOS VERDADEIROS.
*/

/*
  PERFOMANCE ->
  
  PARA OR -> PQ SE O PRIMEIRO É TRUE, ELE JÁ RETORNA.
  V OR F (MAIOR OR MENOR)

  PARA AND -> PQ SE O PRIMEIRO É FALSE, NEM ENTRA NO SEGUNDO.
  F AND V (MENOR AND MAIOR)
...
/* GROUP BY */
SELECT SEXO_DO_AUTOR, COUNT(*) AS "QUANTIDADE"
FROM LIVROS
...
-- ENTÃO ROUPAS > FILMES NO OR (MAIOR OR MENOR): [MINHA QUERY]
...
-- MULHERES DEPARTAMENTO FILMES = 9
-- MULHERES DEPARTAMENTO LAR = 32
-- [MINHA QUERY]
SELECT * FROM funcionarios
WHERE sexo = "Feminino" 
AND (departamento = "Lar"
OR departamento = "Filmes");
